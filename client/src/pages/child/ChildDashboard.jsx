  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold">{user?.name?.split(" ")[0] || "Friend"}! 👋</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { icon: "🎯", label: "Missions", path: `/child/${childId}/missions`, bg: "bg-blue-50", text: "text-blue-700" },
          { icon: "🎁", label: "Rewards", path: `/child/${childId}/rewards`, bg: "bg-yellow-50", text: "text-yellow-700" },
          { icon: "🏅", label: "Badges", path: `/child/${childId}/badges`, bg: "bg-purple-50", text: "text-purple-700" },
        ].map((item) => (
          <Link
            key={item.path}
            to={item.path}
